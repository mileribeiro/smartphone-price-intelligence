...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--db", default=_env("DB_PATH", "data/warehouse/gocase.duckdb"))
    ...
    parser.add_argument("--kafka-consumer-group", default=_env("KAFKA_CONSUMER_GROUP", "gocase-duckdb-loader"))
